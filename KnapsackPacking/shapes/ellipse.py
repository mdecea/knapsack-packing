...
class Ellipse(BaseGeometry):
    ...
    #     return shape_functions.do_shapes_intersect(self.polygon, other)

    # def within(self, other):
    #     """Returns True if geometry is within the other, else False"""

    #     # use the approximate polygon for the check
    #     return shape_functions.does_shape_contain_other(other, self.polygon)

    # def contains(self, other):
    #     """Returns True if the geometry contains the other, else False"""

    #     # use the approximate polygon for the check
    #     return shape_functions.does_shape_contain_other(self.polygon, other)
